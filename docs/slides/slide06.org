...
#+DATE:
# Time-stamp: <2023-05-22 18:29:48 mura>
:REVEAL:
...
- 定理
  ...
  が成り立つ．
  #+end_quote
  - /[[color:orange][絶対値の平均が有界という条件に緩められている]]/
...
- 定理
  ...
  中心極限定理が成り立つ．
  #+end_quote
  - /[[color:orange]["正の分散を持つ"とは定数ではないことを意味する]]/
...
- Lindeberg の条件の確認
  ...
  \(\sqrt{n\mathrm{Var}(X)}\)
  以上離れた標本点が得られるという
  事象 \(|X-\mathbb{E}[X]|\ge\varepsilon\sqrt{n\mathrm{Var}(X)}\)
  の下での分散の評価を表すが，
